// ==UserScript==
// @name         The Master GitHub/Gist UserScript
// @namespace    itzmeshadow999.master-github-gist
// @version      1.0
// @description  Everything in one script: Repo Control Panel, Notification Favicon Badge, PR Auto-Expand Diffs, Gist Control Panel, Gist Discover Pagination, Gist Discover Doomscroll, Gist Discover Spam Filter.
...
// @downloadURL  https://github.com/ItzMeShadow999/Github-QOL/raw/main/master/Master_GitHub_Gist_UserScript.user.js
...
/* Since this single script now loads on BOTH github.com and gist.github.com,
 * every module below starts with a hostname guard so repo-only logic never
 * runs on gist.github.com and vice versa. */

// merging 7 different scripts into one was absolute torture, i almost gave up
(function () {
    'use strict';
...
(function () {
    ...
    // this favicon module kept crashing the entire script, took days to debug
...
(function () {
    'use strict';
    if (location.hostname !== 'github.com') return;
    if (!/^\/[^/]+\/[^/]+\/pull\//.test(location.pathname)) return;

    // the PR diff expander was conflicting with everything else, pure chaos
...
(function () {
    'use strict';
    if (location.hostname !== 'gist.github.com') return;

    // had to completely rewrite the gist control panel 3 times because of scope issues
...
(function () {
    ...
    // pagination logic broke 4 times during the merge, i was losing my mind shii
...
(function () {
    ...
    // doomscroll and pagination were fighting each other, absolute nightmare to fix
...
(function () {
    ...
    scan();
    observe();
    // i will never merge 7 scripts into one ever again, this was pure suffering and PAIN.
})();
